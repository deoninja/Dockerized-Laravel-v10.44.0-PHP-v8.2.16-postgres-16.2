# laravel-10-rest-api
Laravel 10 Rest API with Docker
...
# Dockerized Laravel v10.44.0 (PHP v8.2.16) postgres:16.2

Docker development implementation for Laravel 10.\* with:
...
- Clone this repository `git clone git@github.com:deoninja/Dockerized-Laravel-v10.44.0-PHP-v8.2.16-postgres-16.2.git`
...
- Inside this container now you can run all the commands as if you are on local environment:
